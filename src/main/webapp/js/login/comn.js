		...
		! function(t, n) {
			...
			function w(e, t, n, i, r) {
				for(var o, a, s, l, u, c, d, f = e.length, p = y(t), h = [], g = 0; g < f; g++)
					...
					for(l = l || p.appendChild(t.createElement("div")),
						...
						o = d[0]; o--;)
						l = l.lastChild;
					if(!ge.leadingWhitespace && Je.test(a) && h.push(t.createTextNode(Je.exec(a)[0])), !ge.tbody)
			...
			var Me =
				...
				function(e) {
					...
					var b, w, M, N, T, j, C, L, D, k, S, E, z, I, A, O, H, P, B, _ = "sizzle" + 1 * new Date,
						q = e.document,
						W = 0,
						R = 0,
						F = n(),
						...
						E = t.setDocument = function(e) {
							...
							return i !== z && 9 === i.nodeType && i.documentElement ? (z = i,
								...
								w.getById = r(function(e) {
									return I.appendChild(e).id = _, !z.getElementsByName || !z.getElementsByName(_).length
								}),
										...
										function(t, n, l) {
											...
											if(m) {
												...
												if(h = [a ? m.firstChild : m.lastChild],
													...
													x === !1)
													for(;
														(f = ++p && f && f[g] || (x = p = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== y : 1 !== f.nodeType) || !++x || (v && (d = f[_] || (f[_] = {}),
																c = d[f.uniqueID] || (d[f.uniqueID] = {}),
																c[e] = [W, x]),
															f !== t));)
												;
					...
					return d.prototype = M.filters = M.pseudos,
						...
						L = t.select = function(e, t, n, i) {
							var r, o, a, s, l, u = "function" == typeof e && e,
								d = !i && j(e = u.selector || e);
							if(n = n || [],
								1 === d.length) {
								if(o = d[0] = d[0].slice(0),
									o.length > 2 && "ID" === (a = o[0]).type && w.getById && 9 === t.nodeType && A && M.relative[o[1].type]) {
									if(t = (M.find.ID(a.matches[0].replace(be, we), t) || [])[0], !t)
										return n;
									u && (t = t.parentNode),
										e = e.slice(o.shift().value.length)
								}
								for(r = pe.needsContext.test(e) ? 0 : o.length; r-- && (a = o[r], !M.relative[s = a.type]);)
			...
			var De, ke = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
				Se = ye.fn.init = function(e, t, n) {
					var i, r;
					if(!e)
						return this;
					if(n = n || De,
						"string" == typeof e) {
						if(i = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : ke.exec(e), !i || !i[1] && t)
			...
			ye.event = {
							...
							for(t = (t || "").match(Ie) || [""],
								...
								if(s = nt.exec(t[u]) || [],
									...
									for(d = ye.event.special[p] || {},
										...
										l = o = f.length; o--;)
										a = f[o], !r && g !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || i && i !== a.selector && ("**" !== i || !a.selector) || (f.splice(o, 1),
					...
					trigger: function(e, t, i, r) {
						...
						if(s = c = i = i || se,
							...
							if(e.type = p, !r && !e.isDefaultPrevented() && (!u._default || u._default.apply(f.pop(), t) === !1) && He(i) && a && i[p] && !ye.isWindow(i)) {
								c = i[a],
									c && (i[a] = null),
					...
					mouseHooks: {
						...
						filter: function(e, t) {
							...
							return null == e.pageX && null != t.clientX && (i = e.target.ownerDocument || se,
									...
									e.pageY = t.clientY + (r && r.scrollTop || n && n.scrollTop || 0) - (r && r.clientTop || n && n.clientTop || 0)), !e.relatedTarget && a && (e.relatedTarget = a === e.target ? t.toElement : a),
				...
				ge.change || (ye.event.special.change = {
					...
					teardown: function() {
						return ye.event.remove(this, "._change"), !Ve.test(this.nodeName)
					}
				}),
				ge.focusin || ye.each({
					focus: "focusin",
			...
			ye.extend({
					...
					clone: function(e, t, n) {
						...
						if(ge.html5Clone || ye.isXMLDoc(e) || !rt.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (dt.innerHTML = e.outerHTML,
								dt.removeChild(o = dt.firstChild)), !(ge.noCloneEvent && ge.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ye.isXMLDoc(e)))
							for(i = v(o),
								s = v(e),
								a = 0; null != (r = s[a]); ++a)
								i[a] && S(r, i[a]);
						...
						if(e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
							...
							if(o = typeof n,
								...
								null != n && n === n && ("number" === o && (n += r && r[3] || (ye.cssNumber[s] ? "" : "px")),
									ge.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(a && "set" in a && void 0 === (n = a.set(e, n, i)))))
								try {
									l[t] = n
								} catch(e) {}
						}
			...
			var Ot, Ht, Pt = ye.expr.attrHandle,
			...
			ye.extend({
					...
					ajax: function(e, t) {
						...
						"object" == typeof e && (t = e,
								e = void 0),
							t = t || {};
						var r, o, a, s, l, u, c, d, f = ye.ajaxSetup({}, t),
							p = f.context || f,
							h = f.context && (p.nodeType || p.jquery) ? ye(p) : ye.event,
							g = ye.Deferred(),
